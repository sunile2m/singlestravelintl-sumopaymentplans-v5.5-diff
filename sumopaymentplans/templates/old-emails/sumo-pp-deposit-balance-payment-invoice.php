...
<?php if ( $order->has_status( 'pending' ) ) : ?>
    ...
    <p><?php printf( __( 'Hi, <br>Your Invoice for Balance Payment of %s from payment #%s has been generated . The Payment details are as follows' , SUMO_PP_PLUGIN_TEXT_DOMAIN ) , $product_title , $payment->get_payment_number() ) ; ?></p>
